...
public class Exercicio14 {
  static void main() {
    ...
    System.out.print("Qual a autonomia em km/l: ");
    float autonomia = ler.nextFloat();
    float distanciaTotal = nVoltas*comprimento;
    float litrosTotais = distanciaTotal/autonomia;
    float litrosReabastecimento = litrosTotais/nAbastece;
    System.out.printf("Para o GP serão necessários %.2f litros por abastecimento\n",litrosReabastecimento);
